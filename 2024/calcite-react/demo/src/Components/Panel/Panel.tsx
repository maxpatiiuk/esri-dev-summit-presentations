...
import { CalciteBlock, CalciteShellPanel, CalcitePanel } from '@esri/calcite-components-react';
...
export const Panel = ({ view, panelHeading }: PanelProps) => { 
    ...
    const [ featuresWidget, setFeaturesWidget] = useState<__esri.Features | null>(null);
